...
# -------------- Images --------------
Img1 = CTkImage(light_image=Image.open("assets/imgs/Eagle.png"),
        dark_image=Image.open("assets/imgs/Eagle.png"), size=(100,80))
Img2 = CTkImage(light_image=Image.open("assets/imgs/remove2.png"),
        dark_image=Image.open("assets/imgs/remove2.png"), size=(24,24))
Img3 = CTkImage(light_image=Image.open("assets/imgs/logout.png"),
        dark_image=Image.open("assets/imgs/logout.png"), size=(24,24))
Img4 = CTkImage(light_image=Image.open("assets/imgs/more.png"),
        dark_image=Image.open("assets/imgs/more.png"), size=(26,26))
Img5 = CTkImage(light_image=Image.open("assets/imgs/remove3.png"),
        dark_image=Image.open("assets/imgs/remove3.png"), size=(42,42))
Img6 = CTkImage(light_image=Image.open("assets/imgs/support.png"),
        dark_image=Image.open("assets/imgs/support.png"), size=(28,28))
Img7 = CTkImage(light_image=Image.open("assets/imgs/whatsapp.png"),
        dark_image=Image.open("assets/imgs/whatsapp.png"), size=(26,26))
Img8 = CTkImage(light_image=Image.open("assets/imgs/about.png"),
        dark_image=Image.open("assets/imgs/about.png"), size=(26,26))
Img9 = CTkImage(light_image=Image.open("assets/imgs/contact.png"),
        dark_image=Image.open("assets/imgs/contact.png"), size=(28,28))
Img10 = CTkImage(light_image=Image.open("assets/imgs/setting2.png"),
        dark_image=Image.open("assets/imgs/setting2.png"), size=(26,26))
Img11 = CTkImage(light_image=Image.open("assets/imgs/home.png"),
        dark_image=Image.open("assets/imgs/home.png"), size=(36,36))
Img12 = CTkImage(light_image=Image.open("assets/imgs/car-rental.png"), 
        dark_image=Image.open("assets/imgs/car-rental.png"), size=(42,42))
Img13 = CTkImage(light_image=Image.open("assets/imgs/car.png"),
        dark_image=Image.open("assets/imgs/car.png"), size=(34,34))
Img14 = CTkImage(light_image=Image.open("assets/imgs/facebook.png"),
        dark_image=Image.open("assets/imgs/facebook.png"))
Img15 = CTkImage(light_image=Image.open("assets/imgs/instagram.png"),
        dark_image=Image.open("assets/imgs/instagram.png"))
Img16 = CTkImage(light_image=Image.open("assets/imgs/website.png"),
        dark_image=Image.open("assets/imgs/website.png"))
Img17 = CTkImage(light_image=Image.open("assets/imgs/linkedin.png"),
        dark_image=Image.open("assets/imgs/linkedin.png"))
Img18 = CTkImage(light_image=Image.open("assets/imgs/mail.png"),
        dark_image=Image.open("assets/imgs/mail.png"))
Img111 = CTkImage(light_image=Image.open("assets/imgs/home.png"),
        dark_image=Image.open("assets/imgs/home.png"), size=(32,32))
Img122 = CTkImage(light_image=Image.open("assets/imgs/car-rental.png"),
        dark_image=Image.open("assets/imgs/car-rental.png"), size=(42,42))
Img133 = CTkImage(light_image=Image.open("assets/imgs/car.png"),
        dark_image=(Image.open("assets/imgs/car.png")), size=(35,35))
Img144 = CTkImage(light_image=Image.open("assets/imgs/blog.png"),
        dark_image=Image.open("assets/imgs/blog.png"), size=(40,40))
