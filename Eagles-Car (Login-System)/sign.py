...
root_sign.geometry("500x480+850+300")
...
# -------------- All - Tools --------------
img1 = CTkImage(Image.open("assets/imgs/pattern.png"))
open_eye = CTkImage(light_image=Image.open("assets/imgs/eye.png"),
        dark_image=Image.open("assets/imgs/eye.png"), size=(19,19))
close_eye = CTkImage(light_image=Image.open("assets/imgs/hidden.png"),
        dark_image=Image.open("assets/imgs/hidden.png"), size=(18,18))
