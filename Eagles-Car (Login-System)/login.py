...
root = CTk()
root.title('Eagles Car (Login System) v3.6.5')
...
def Hide_password_function():
    ...
    Open_eye_Button.place(relx=0.643, rely=0.575, anchor=CENTER)
...
def Show_password_function():
    ...
    Close_eye_Button.place(relx=0.643, rely=0.575, anchor=CENTER)

# -------------- Images --------------
img = CTkImage(light_image=Image.open("assets/imgs/Eagle.png"),
    dark_image=Image.open("assets/imgs/Eagle.png"), size=(120,95))
img1 = CTkImage(light_image=Image.open("assets/imgs/Eagle-Bg.png"),
    dark_image=Image.open("assets/imgs/Eagle-Bg.png"), size=(1000,700))
open_eye = CTkImage(light_image=Image.open("assets/imgs/eye2.png"),
    dark_image=Image.open("assets/imgs/eye2.png"), size=(17,17))
close_eye = CTkImage(light_image=Image.open("assets/imgs/hidden2.png"),
    dark_image=Image.open("assets/imgs/hidden2.png"), size=(19,19))

# -------------- Logo - Images --------------
Background_logo = CTkLabel(master=root,image=img1, text="")
Background_logo.place(relx=0.5, rely=0.55, anchor=CENTER)

# -------------- Frame - Logo --------------
Frame1 = CTkFrame(master=Background_logo, width=360, height=400, bg_color="transparent", fg_color="transparent")
Frame1.place(relx=0.5, rely=0.46, anchor=CENTER)

Logo_frame = CTkLabel(master=Frame1, text="",image=img)
Logo_frame.place(relx=0.5, rely=0.255, anchor=CENTER)
